<template>
  <el-container style="height: 100vh;">
    <el-aside width="200px"
      ...
      <el-menu router :default-openeds="['1']" unique-opend :default-active="$route.path">
        <el-submenu index="1">
          <template slot="title"><i class="el-icon-message"></i>内容管理</template>
          <el-menu-item-group>
            <template slot="title">英雄</template>
            <el-menu-item index="/heroes/creat">新建英雄</el-menu-item>
        ...
        <el-submenu index="3">
          ...
          <el-menu-item-group>
            ...
            <el-menu-item index="/categories/creat">新建分类</el-menu-item>
            <el-menu-item index="/categories/list">分类列表</el-menu-item>
          </el-menu-item-group>
           <el-menu-item-group>
            <template slot="title">物品</template>
            <el-menu-item index="/items/creat">新建物品</el-menu-item>
